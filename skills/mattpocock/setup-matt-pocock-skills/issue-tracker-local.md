...
Issues and specs (you may know a spec as a PRD) for this repo live as markdown files in `.brandonnoad/issue-tracker/`.

## Conventions

- One feature per directory: `.brandonnoad/issue-tracker/<feature-slug>/`
- The spec is `.brandonnoad/issue-tracker/<feature-slug>/spec.md`
...
Create a new file under `.brandonnoad/issue-tracker/<feature-slug>/` (creating the directory if needed).

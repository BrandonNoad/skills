...
Write the spec to `.brandonnoad/specs/<feature-slug>.md`, creating the `specs/` directory if needed.

## When a skill says "find the spec"

Read `.brandonnoad/specs/<feature-slug>.md`. The user will normally pass the feature slug or the path directly; otherwise infer the slug from the branch name or feature under discussion.
